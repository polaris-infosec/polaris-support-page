...
***Note:*** Polaris does not automatically apply SSL certificates when users upload them, even if the certificates have
expired. This means that users need to manage the lifecycle of the certificates themselves.
